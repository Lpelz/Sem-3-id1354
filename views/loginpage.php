...
<html>
    ...
    <body id = "home">
        ...
        <ul>      
            ...
            <li><a class= "current" href="ShowLogin"><img  alt="Login" src="../../resources/images/loginicon.png"><p>Login page</p></a></li>
     ...
     <?php
        ...
        <div class ="homepage">            
            <form class ="loginpage" action="Login" method="post">
                ...
                <br><b>
           <?php if(($this->session->get(Constants::INVALID_LOGIN_MESSAGE)!= null)){
                  echo $this->session->get(Constants::INVALID_LOGIN_MESSAGE);
                  $this->session->set(Constants::INVALID_LOGIN_MESSAGE,null);
                 }?> </b>
            </form>          
        </div>
    </body>
